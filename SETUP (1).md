...
```
Registro simple de trazabilidad: cada vez que José genera un mail de solicitud de cotización desde la Bandeja, queda una fila acá con qué ítems se cotizaron y a qué emails. No es el módulo completo de Cotizaciones (eso queda para más adelante) — es solo un historial mínimo.
